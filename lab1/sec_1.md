...
> + 了解 ARM 处理器内核 (教材 3.3.1)
> + 了解 Cortex-M0 内核架构与编程模型 (教材 3.3.2)
> + 掌握 ARM 基础指令, 如 MOV, ADD, SUB, LDR, STR, CMP 和一些转移指令等 (教材 4.1)
> + 掌握 ARM 基础伪指令, 如 AREA, DCD, SPACE, EQU, LDR 等 (教材 4.1.15 和 4.2.2)  
...
<!-- -->
> #### fread::迷惑众人的 LDR 伪指令
> 试想如果没有 LDR 伪指令, 我们在程序编写中会遇到这样两种问题: 
